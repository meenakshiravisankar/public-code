...
train_image_path = "idd_segmentation_1/leftImg8bit/train/"
train_label_path = "idd_segmentation_1/gtFine/train/"

val_image_path = "idd_segmentation_1/leftImg8bit/val/"
val_label_path = "idd_segmentation_1/gtFine/val/"

test_image_path = "idd_segmentation_1/leftImg8bit/test/"
...
# write to file
train_f = open("list/idd/1/train.lst", "w")
val_f = open("list/idd/1/val.lst", "w")
test_f = open("list/idd/1/test.lst", "w")
